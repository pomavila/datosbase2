...
// Portfolio data for carousel
    ...
    const portfolioData = [
    {
        id: 1,
        title: 'Unidad 1',
        description: 'Fundamentos de bases de datos y conceptos básicos.',
        image: 'images/neural-network.jpg',
        tech: ['Semana 1', 'Semana 2', 'Semana 3', 'Semana 4']
    },
    {
        id: 2,
        title: 'Unidad 2',
        description: 'Modelado de datos y diseño de bases de datos.',
        image: 'images/quantum-cloud.jpg',
        tech: ['Semana 5', 'Semana 6', 'Semana 7', 'Semana 8']
    },
    {
        id: 3,
        title: 'Unidad 3',
        description: 'Consultas SQL y manipulación de datos.',
        image: 'images/blockchain-vault.jpg',
        tech: ['Semana 9', 'Semana 10', 'Semana 11', 'Semana 12']
    },
    {
        id: 4,
        title: 'Unidad 4',
        description: 'Optimización y administración de bases de datos.',
        image: 'images/cyber-defense.jpg',
        tech: ['Semana 13', 'Semana 14', 'Semana 15', 'Semana 16']
    }
        ...
        function createCarouselItem(data, index) {
            ...
            item.innerHTML = `
                <div class="card">
                    ...
                    <button class="card-cta" onclick="scrollToSection('stats')">Explorar</button>
                </div>
            `;
